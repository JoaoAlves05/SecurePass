...
def get_feedback(score, sequence):
    if len(sequence) == 0:
        return {
            'warning': '',
            'suggestions': [
                _("Use a few uncommon words (a passphrase) to increase length and unpredictability."),
                _("Include symbols, digits, and mixed-case characters to make the password stronger.")
            ]
        }
